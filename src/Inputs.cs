...
namespace trrne.Box
{
    public static class Inputs
    {
        ...
        public static bool DownOr(params string[] names) => (from n in names where Down(n) select n).Count() >= 1;
        public static bool DownAnd(params string[] names) => (from n in names where Down(n) select n).Count() == names.Length;
        ...
        public static bool PressedOr(params string[] names) => (from n in names where Pressed(n) select n).Count() >= 1;
        public static bool PressedAnd(params string[] names) => (from n in names where Pressed(n) select n).Count() == names.Length;
        ...
        public static bool UpOr(params string[] names) => (from n in names where Up(n) select n).Count() >= 1;
        public static bool UpAnd(params string[] names) => (from n in names where Up(n) select n).Count() == names.Length;
